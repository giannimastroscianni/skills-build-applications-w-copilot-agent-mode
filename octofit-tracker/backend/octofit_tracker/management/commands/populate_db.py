...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        Activity.objects.create(user=users[1], type='Cycling', duration=45, date='2025-12-01')
        Activity.objects.create(user=users[2], type='Swimming', duration=60, date='2025-12-01')
        Activity.objects.create(user=users[3], type='Yoga', duration=20, date='2025-12-01')
